...
def protein_params(parser):
    ...
    parser.add_argument('--emb_type_1', type=str, default="Exon")
    parser.add_argument('--emb_type_2', type=str, default="non_exon")
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--seed', type=int, default=1230)  # 1230
...
def nucleotide_params(parser):
    ...
    parser.add_argument('--emb_type', type=str, default="pca")
    parser.add_argument('--gpu', type=int, default=0)
